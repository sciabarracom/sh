...
// At this time, returning a zero-length slice is not supported.
// TODO: should we allow CallHandlerFunc to return an error, too?
//
...
type CallHandlerFunc func(ctx context.Context, args []string) []string
